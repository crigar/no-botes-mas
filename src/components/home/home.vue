<template>
    <div >
      <div  v-bind:class="{ 'background-sort': isHome, 'background-long': !isHome  }" id="home">
        <!-- Navigation -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 text-center">
              ...
              <h3 class="section-subheading text-muted">Los integrantes del equipo son</h3>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-4">
